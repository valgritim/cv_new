...
if(!empty($_POST))
{
    ...
    else /*je dois récuperer toutes les infos sur mon item apres le GET grace à l'id donc avant le POST*/
    {
        ...
        $image = $item['image'];  
        Database::disconnect();
        /*je repartis les valeurs avec les donnees de ma baseselon les champs de mon formulaire*/
    }
...
?>
    ...
    <body>
        ...
        <h1 class="text-logo"><span class="glyphicon glyphicon-cutlery"></span> Brooklyn Burger <span class="glyphicon glyphicon-cutlery"></span></h1>
                ...
                <div class="col-sm-6 site">
                    <div class="thumbnail">
                        ...
                        <div class="caption ">
                            ...
                            <a href="# " class="btn btn-order " role="btn "><span class="glyphicon glyphicon-shopping-cart "></span> COMMANDER</a>
                        </div>
                    </div>
                </div>
